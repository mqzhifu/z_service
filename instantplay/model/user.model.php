...
class UserModel {
    ...
    static $_type_messenger = 15;
    static $_type_insystem = 16;
    ...
    static function getTypeDesc(){
        return array(
            ...
            self::$_type_messenger =>'messenger分享',
            self::$_type_insystem =>'系统内应用分享',
     ...
     * @return bool
     */
    public static function getInfo($count, $callback)
    {
        do {
